...
const Transactions: React.FC<Props> = ({ navigation }) => {
  ...
  const transactions: Transaction[] = [
    {
      ...
      cardNumber: '9567',
      icon: (
        <Icon name="arrow-downward" size={20} color="#FF5E7D" />
      ),
    },
    {
      id: '2',
      ...
      cardNumber: '9567',
      icon: (
        <Icon name="arrow-upward" size={20} color="#4ECDC4" />
      ),
    },
    {
      id: '3',
      ...
      cardNumber: '9567',
      icon: (
        <Icon name="local-cafe" size={20} color="#FF9F1C" />
      ),
    },
    {
      id: '4',
    ...
    },
    {
      ...
      cardNumber: '9567',
      icon: (
        <Icon name="directions-car" size={20} color="#7A5AF8" />
      ),
    },
    {
      id: '6',
      ...
      cardNumber: '9567',
      icon: (
        <Icon name="shopping-cart" size={20} color="#FF5E7D" />
      ),
    },
    {
      id: '7',
      ...
      cardNumber: '9567',
      icon: (
        <Icon name="tv" size={20} color="#FF5E7D" />
      ),
    },
  ];
